...
module PgHero
  ...
  # settings
  class << self
    attr_accessor :long_running_query_sec, :slow_query_ms, :slow_query_calls, :explain_timeout_sec, :total_connections_threshold, :unused_index_threshold, :cache_hit_rate_threshold, :env, :show_migrations, :config_path, :filter_data
  end
  ...
  self.unused_index_threshold = 10 * 1024 * 1024
